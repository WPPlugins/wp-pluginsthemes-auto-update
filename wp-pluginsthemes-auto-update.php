...
function wpptau_admin_page() {
	...
	if (isset($_POST['wpptau_themes_auto_update'])) {
			if ($wpptau_is_multisite) {
				update_site_option('wpptau_themes_auto_update',$_POST['wpptau_themes_auto_update']);
			} else {
				update_option('wpptau_themes_auto_update',$_POST['wpptau_themes_auto_update']);
			}
	}
	if (isset($_POST['wpptau_plugins_auto_update'])) {
			if ($wpptau_is_multisite) {
				update_site_option('wpptau_plugins_auto_update',$_POST['wpptau_plugins_auto_update']);
			} else {
				update_option('wpptau_plugins_auto_update',$_POST['wpptau_plugins_auto_update']);
			}
	}
	?>
	<div class="wrap">
